    ...
    >
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center px-4 py-16">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full bg-indigo-100/10 px-3 py-1 text-indigo-300 text-xs font-medium">
              <Sparkles className="h-4 w-4" /> Nouveau • Compagnon robotique
              personnalisable
            </div>
      ...
      <section id="features" className="py-16">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="mt-2 text-slate-300">
            Configurables selon vos envies, conçues pour rassurer et assister.
          </p>
      ...
      <section id="video" className="py-16 border-y border-slate-800">
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="mt-2 text-slate-300">
              SYMPA en situation réelle : assistance, interaction et présence
              rassurante.
            </p>
            <ul className="mt-4 space-y-2 text-sm text-slate-300">
              <li className="flex gap-2">
                <Check className="h-5 w-5 text-indigo-400" /> Versions « chien »
                et « chat »
              </li>
              <li className="flex gap-2">
                <Check className="h-5 w-5 text-indigo-400" /> Slogan :{" "}
                <i>« SYMPA, le compagnon qui veille et protège »</i>
              </li>
            </ul>
          </div>
      ...
      <section id="pricing" className="py-16">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="mt-2 text-slate-300">
            Choisissez l’option qui convient à vos besoins. Tarifs de lancement
            v1.
          </p>
            ...
            <Card className="border-indigo-500/20">
              ...
              <CardContent className="space-y-3 text-sm text-slate-300">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex gap-2">
                    <Check className="h-5 w-5 text-indigo-400" /> Mises à jour &
                    télésurveillance
                  </li>
                  <li className="flex gap-2">
                    <Check className="h-5 w-5 text-indigo-400" /> Échange
                    standard en 48h
                  </li>
                </ul>
                <Button
            ...
            <div className="p-6 md:p-8 grid md:grid-cols-3 gap-6 md:gap-10 items-center">
              <div className="md:col-span-2">
                ...
                <p className="mt-2 text-slate-300 text-sm">
                  ...
                  Règlement disponible sur demande. Offre valable jusqu’à
                  épuisement du stock de lancement.
                </p>
          ...
          <div className="mt-8">
            <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6 text-slate-300">
              ...
              <p className="text-sm mt-1">
                Démonstrations en EHPAD, journées portes ouvertes et ateliers
                aidants. Restez connectés !
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="faq" className="py-16 border-y border-slate-800">
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-6 text-sm text-slate-300">
          <Card>
            <CardHeader>
              <CardTitle>Le robot est-il sûr ?</CardTitle>
            </CardHeader>
            <CardContent>
              Oui, SYMPA suit un plan sécurité et des tests de qualification.
              Les aides au relevage sont guidées et surveillées.
            </CardContent>
          </Card>
          <Card>
            <CardHeader>
              <CardTitle>Mes données sont-elles protégées ?</CardTitle>
            </CardHeader>
            <CardContent>
              Minimisation des données, consentements clairs, hébergement
              conforme RGPD.
            </CardContent>
          </Card>
          <Card>
            ...
            <CardContent>
              Oui, apparence personnalisable à l’achat et adaptable.
            </CardContent>
          </Card>
          <Card>
            <CardHeader>
            ...
            <CardContent>
              Mises à jour à distance et support sous 48h.
            </CardContent>
          </Card>
        </div>
      </section>
